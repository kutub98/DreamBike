...
const Testimonial = () => {
    return (
        <div className='py-6 px-[10%] bg-slate-50'>
	...
	<div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div className="flex flex-col items-center mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">YDBIKE is really amazing with there products , service as well thier behaviour.</p>
		...
		<div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">YDBIKE is really amazing with there products , service as well thier behaviour. I will recommand you to buy Your Dream Bike from the <span className='text-red-600'>YDBIKE</span></p>
