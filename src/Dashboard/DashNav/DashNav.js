  ...
  const menuItem = (
    <React.Fragment>
      <li className="p-2" onClick={() => setOpenMenu(!openMenu)}>
        <Link className=" text-[16px]" to="/Home">
         Main Home
        </Link>
      </li>
      <li className="p-2" onClick={() => setOpenMenu(!openMenu)}>
        <Link className=" text-[16px]" to="/Dashboard/AllUsers">
          All Users{" "}
        </Link>
      </li>
      <li className="p-2" onClick={() => setOpenMenu(!openMenu)}>
        <Link className=" text-[16px]" to="/Dashboard/MyProduct">
          My Products{" "}
        </Link>
      </li>
      <li className="p-2" onClick={() => setOpenMenu(!openMenu)}>
        <Link to="/Dashboard/AllSeller" className=" text-[16px]">
          All Sellers
        </Link>
      </li>
      <li className="p-2" onClick={() => setOpenMenu(!openMenu)}>
        <Link className=" text-[16px]" to="/DashBoard/AllBuyers">
          All Buyers
        </Link>
      </li>
      <li className="p-2" onClick={() => setOpenMenu(!openMenu)}>
        <Link className=" text-[16px]" to="/DashBoard/Reported">
          Reported Items
        </Link>
      </li>
